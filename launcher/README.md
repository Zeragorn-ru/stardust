...
Если она не задана, используется `http://127.0.0.1:8080` (локальная разработка).

```sh
# пример: сервер на другой машине/порту
LAUNCHER_AUTH_URL=http://192.168.1.10:8080 npm run tauri dev
```
